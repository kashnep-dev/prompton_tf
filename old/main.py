...
def handle_search_type(search_type, company):
    if search_type == 'get_news':
        ...
        return CustomPromptTemplate.STOCK_INFO_CONTEXT.value.format(start_date, end_date, company, str(plot_pattern), monthly_price)
    return ''
...
def setup_sidebar():
    with st.sidebar:
        ...
        expander.write(""" Introducing Stock Summary and Financial Information Summarization with Generative AI (LLM) And Users can easily find the information they need in various documents, including securities terms and conditions. """)
